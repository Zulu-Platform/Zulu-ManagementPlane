...
public enum ErrorsMessage {
    ...
    ERROR_TYPE_REQUEST(7, "ERROR_TYPE_REQUEST"),
    /** Неверный тип ответа. */
    ERROR_TYPE_RESPONSE(8, "ERROR_TYPE_RESPONSE"),
    /** Ошибка регистрации пользователя. */
    ERROR_REGISTRATION(9, "ERROR_REGISTRATION"),
    /** Нет ответа от сервера. */
    ERROR_NO_RESPONSE(10, "ERROR_NO_RESPONSE"),
    /** Большой объем данных. */
    ERROR_LONG_DATA(11, "ERROR_LONG_DATA");
